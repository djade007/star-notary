...
contract StarNotary is ERC721 {
    ...
    // Token name
    string public constant name = "Great Token";
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(tokenIdToStarInfo[_tokenId1] == msg.sender || tokenIdToStarInfo[_tokenId2] == msg.sender, "You are not the owner of any of the stars");
        //2. You don't have to check for the price of the token (star)
        //3. Get the owner of the two tokens (ownerOf(_tokenId1), ownerOf(_tokenId1)
        address memory owner1 = ownerOf(_tokenId1);
        address memory owner2 = ownerOf(_tokenId2);
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        address memory owner1 = ownerOf(_tokenId);
        require(owner1 == msg.sender, "You are not the owner of the star");
